    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="dashboard-box margin-top-0">
          ...
          <!-- Headline -->
          <div class="headline">
            <h3><i class="icon-material-outline-business"></i> Rate Freelance</h3>
          </div>
          ...
          <div class="content">
            ...
            if($sql = $m->View($select, $table, "", "", $arr)){
              while($data=$sql->fetch_object()){
                  $id = $data->id;
                  $results = $data->freelancer_rating;
...
<div class="sign-in-form">
  ...
  <div class="popup-tabs-container">
    ...
    <div class="popup-tab-content" id="tab2">
      ...
      <!-- Form -->
      <form method="post" action="index.php?fre=free_rating&id=<?php echo $id;?>"  id="leave-review-form">
