<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['sub']) {
	 ...
	 if ($msg) {
		 ...
		 $file = fopen("views/freelancer/Buyer_txt_file/{	$fid}.txt", "w") or die("file not open");
		 fwrite($file, $_POST['description']) or die();
		 fclose($file);

		 $arr = array(
			 "freelancer_rating" => $_POST['r_1'],
			 "freelancer_rating" => $_POST['r_2'],
			 "freelancer_rating" => $_POST['r_3'],
			 "freelancer_rating" => $_POST['r_4'],
			 "freelancer_rating" => $_POST['r_5'],
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-business"></i> Rate Freelancers</h3>
						</div>
						...
						<div class="content">
							<ul class="dashboard-box-list">
								...
								$select = "jobs.*, buyers.name as bname, category.name as cname";
								$table ="jobs, buyers, category";
								...
								<li>
									...
									<a href="#freelancer" class="popup-with-zoom-anim button ripple-effect margin-top-5 margin-bottom-10"><i class="icon-material-outline-thumb-up"></i> Leave a Review</a>
								</li>
								<?php
							}
						}
				...
				<div class="col-xl-6">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-face"></i> Rate Employers</h3>
						</div>
...
<section>
<div id="freelancer" class="zoom-anim-dialog mfp-hide dialog-with-tabs">
	...
	<div class="sign-in-form">
		...
		<div class="popup-tabs-container">
			...
			<div class="popup-tab-content" id="tab1">
				...
				<!-- Form -->
				<form method="post" action="" enctype="multipart/form-data"id="change-review-form">
					...
					<div class="feedback-yes-no">
						<strong>Your Rating</strong>
						<div class="leave-rating">
							<input type="radio" name="r_1" id="rating-1" value="1" checked/>
							<label for="rating-1" class="icon-material-outline-star"></label>
							<input type="radio" name="r_2" id="rating-2" value="2"/>
							<label for="rating-2" class="icon-material-outline-star"></label>
							<input type="radio" name="r_3" id="rating-3" value="3"/>
							<label for="rating-3" class="icon-material-outline-star"></label>
							<input type="radio" name="r_4" id="rating-4" value="4"/>
							<label for="rating-4" class="icon-material-outline-star"></label>
							<input type="radio" name="r_5" id="rating-5" value="5"/>
				...
				<!-- Button -->
				<button class="button full-width button-sliding-icon ripple-effect" type="submit" name="sub"form="change-review-form">Save Changes <i class="icon-material-outline-arrow-right-alt"></i></button>
