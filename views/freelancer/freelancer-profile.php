						...
						<div class="header-details">
							...
							<ul>
								...
								<li>
									...
									if($rating = $m->View("*", "jobs", "", ['freelancer_id'=>$_GET['id']])){
									while($data = $rating->fetch_object()){
											$arr[]=$data->buyer_rating ;
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				<div class="profile-overview">
					<div class="overview-item"><strong>$<?php echo $result->hourly_rate; ?></strong><span>Hourly Rate</span></div>
            ...
            <?php
            $arr =array(
              'freelancer_skills.freelancer_id'=> $get,
            ...
            $select="freelancer_skills.id, skills.name sname";
            $table ="freelancer_skills, skills";
