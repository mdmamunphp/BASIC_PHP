				...
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="dashboard-box margin-top-0">
							...
							<!-- Headline -->
							<div class="headline">
								<h3><i class="icon-feather-folder-plus" class="input-text with-border" name="name" ></i> Add Skills</h3>
							</div>
							...
							<div class="content with-padding padding-bottom-10">
								<div class="row col-sm-6">
									...
									<!-- NAME -->
									<input type="text" class="input-text with-border"  name="name" placeholder="Enter your skills">
								</div>
							</div>
