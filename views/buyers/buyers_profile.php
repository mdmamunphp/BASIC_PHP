			...
			<div class="col-md-12">
				...
				<div class="single-page-header-inner">
					<div class="left-side">
						...
						<div class="header-image freelancer-avatar"><?php echo "<img src='views/buyers/reg_images/{$get}.{$pic}' alt=''>" ?></div>
						<div class="header-details">
							<h3><?php echo $result->name ; ?><span><?php echo $result->designation ; ?></span></h3>
							<ul>
								<li>
                  <?php
                  if($rating = $m->View("*", "jobs", "", ['buyer_id'=>$_GET['id']])){;
                  while($data = $rating->fetch_object()){
                      $arr[]=$data->freelancer_rating;

                    };
                    $average = array_sum($arr)/count($arr);
                    ?>
                  <div class="star-rating" data-rating="<?php echo $average ;?>"></div></li>
                  <?php
                };
