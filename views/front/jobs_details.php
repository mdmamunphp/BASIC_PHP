<?php
	...
	extract($_POST);
		...
		$select ="buyers.*, jobs.*";
		$table ="buyers, jobs";
	if($res = $m->View($select, $table, "", "", $arr)){
...
<a href="index.php?buy=buyers_profile&id=<?php echo $bid;?>">
							<?php
						...
						<a href="#" class="job-listing">
							...
							<div class="job-listing-details">
								...
								<div class="job-listing-company-logo">
									<?php echo "<img src='views/buyers/images/{$data->id}.png' alt=''>" ?>
								</div>

								<!-- Details -->
								<div class="job-listing-description">
									<h4 class="job-listing-company">Coffee <?php echo $value->buyer_id ;?></h4>
							...
							<div class="job-listing-footer">
								<ul>
									<li><i class="icon-material-outline-location-on"></i> <?php echo $value->location ;?></li>
									<li><i class="icon-material-outline-business-center"></i><?php echo $value->job_type ;?></li>
									<li><i class="icon-material-outline-account-balance-wallet"></i><?php echo  $value->min_rate ;?>-<?php echo $data->max_rate ;?></li>
									<li><i class="icon-material-outline-assets-time"></i> <?php echo $data->date ;?></li>
								</ul>
							</div>
						</a>
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span><?php echo $data->job_type_id ?></span>
								...
								<li>
									...
									<?php
									 ...
									 ?>
									<h5><?php echo $data->job_type_id ?></h5>
								</li>
								<li>
