...
<div class="header">
<h1>404 -&nbsp;Not Found</h1>
<h2>The page you are trying to assets does not exist. <br />
...
have re-named the htassets.txt file to .htassets. If there is already a
non-empty .htassets file read it and make sure the necessary rules are
un-commented.
</li></ul></div>
</div>
</div>
