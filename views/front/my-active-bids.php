			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<?php
						$m = new Models();
					 $results = $m->DBRaw("select * from applicants where applicants.freelancer_id ='{$_SESSION['id']}' order by id desc limit 4");
									...
									<div class="job-listing width-adjustment">
										...
										<div class="job-listing-details">
											...
											<div class="job-listing-description">
												<h3 class="job-listing-title"><a href="#">WordPress Guru Needed</a><?php echo $value->id ; ?></h3>
											</div>
										</div>
									</div>
