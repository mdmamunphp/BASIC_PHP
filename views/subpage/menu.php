		...
		if(isset($_SESSION['id'])){
			...
			if($_SESSION['type'] == 3){
							...
							<div class="header-notifications-content">
								<div class="header-notifications-scroll" data-simplebar>
									<ul>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-online"><?php echo "<img src='views/buyers/reg_images/{$_SESSION['id']}.{$pic}' alt=''>" ?></span>
												<div class="notification-text">
													<strong>David Peterson</strong>
													<p class="notification-msg-text">Thanks for reaching out. I'm quite busy right now on many...</p>
													<span class="color">4 hours ago</span>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-offline"><?php echo "<img src='views/buyers/reg_images/{$_SESSION['id']}.{$pic}' alt=''>" ?></span>
												<div class="notification-text">
													<strong>Sindy Forest</strong>
													<p class="notification-msg-text">Hi Tom! Hate to break it to you, but I'm actually on vacation until...</p>
													<span class="color">Yesterday</span>
				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						<div class="header-notifications-trigger">
							<a href="#"><div class="user-avatar status-online"><?php echo "<img src='views/buyers/reg_images/{$_SESSION['id']}.{$pic}' alt=''>" ?></div></a>
						</div>
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<!-- User Name / Avatar -->
								<div class="user-details">
									<div class="user-avatar status-online"><?php echo "<img src='views/buyers/reg_images/{$_SESSION['id']}.{$pic}' alt=''>" ?></div>
									<div class="user-name">
										<?php echo $data->name ; ?> <span>Employeer</span>
									</div>
								</div>
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<a href="index.php?fre=freelancer-profile&id=<?php echo $_SESSION['id'] ;?>">	<?php echo "<img src='views/freelancer/reg_images/{$_SESSION['id']}.jpeg' alt=''>" ?> </a></div>
									<div class="user-name">
										<?php echo $data->name ; ?> <span>Freelancer</span>


										<span>Blance</span><span>$
												<?php
												$model = $m->View("*", "applicants", '',['freelancer_id'=> $_SESSION['id']]);

												while($balance = $model->fetch_object()) {
				...
				<div class="header-widget">
					<div class="user-details" style="padding-top:30%;">
						<div style="padding-right:10%";>
							<a href="index.php?f=freeleancer_reg"><span>SingUp</span></a>
						</div>
