                            ...
                            <div class="tab-content">
								...
								<div id="tab-1"  class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/blog-add-confirm');?>" enctype="multipart/form-data" method="post">
												
												<div class="form-group row"><label class="col-sm-2 col-form-label">Title:</label>
													<div class="col-sm-10"><input type="text" name="title" class="form-control" placeholder="Name"></div>
												</div>

												
												<div class="form-group row"><label class="col-sm-2 col-form-label">date:</label>
													<div class="col-sm-10"><input type="date" name="date" class="form-control" placeholder="amount"></div>
												</div>
	...
	<!-----------------#############################  donate add  ########################################################################--------------------->
                                <div id="tab-2" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/donate-add-confirm');?>" enctype="multipart/form-data" method="post">
												
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">ID:</label>
                                                <div class="col-sm-10"><input type="text" name="people_id" class="form-control"  placeholder="0123456789"></div>
                                            </div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">Amount:</label>
                                                <div class="col-sm-10"><input type="text" name="amount" class="form-control"  placeholder="amount"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Name:</label>
                                                <div class="col-sm-10"><input type="text" name="name" class="form-control" placeholder="Name"></div>
											</div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">Designetion:</label>
                                                <div class="col-sm-10"><input type="text" name="designation" class="form-control" placeholder="Designetion"></div>
                                            </div>
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">contact:</label>
                                                <div class="col-sm-10"><input type="text" name="contact" class="form-control" placeholder="contact"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Sort description:</label>
                                                <div class="col-sm-10"><input type="text" name="short_description" class="form-control" placeholder=" Sort description"></div>
											</div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">Images:</label>
                                                <div class="col-sm-10"><input type="file" name="images" class="form-control"></div>
											</div>
 		...
 		<!-----------------#############################  donate add end   ########################################################################--------------------->
                              	<!---------------------------------------------------------------- events add -------------------------------------->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/events-add-confirm');?>" enctype="multipart/form-data" method="post">
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">time:</label>
                                                <div class="col-sm-10"><input type="time" name="time" class="form-control" placeholder="amount"></div>
											</div>
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">location:</label>
                                                <div class="col-sm-10"><input type="text" name="location" class="form-control" placeholder="amount"></div>
											</div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">Images:</label>
                                                <div class="col-sm-10"><input type="file" name="images" class="form-control"></div>
											</div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-stripped">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url();?>dasset/img/gallery/2s.jpg">
                                                    </td>
                                                    <td>
								...
								<div id="tab-5" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/gallery-add-confirm');?>" enctype="multipart/form-data" method="post">
												
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Title:</label>
                                                <div class="col-sm-10"><input type="text" name="title" class="form-control" placeholder="Name"></div>
											</div>

											<div class="form-group row"><label class="col-sm-2 col-form-label">Images Date:</label>
                                                <div class="col-sm-10"><input type="text" name="img_date" class="form-control"  placeholder="amount"></div>
                                            </div>
                                            
											<div class="form-group row"><label class="col-sm-2 col-form-label">People Images:</label>
                                                <div class="col-sm-10"><input type="text" name="people_img" class="form-control" placeholder="Designetion"></div>
											</div>
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">Home Page Images:</label>
                                                <div class="col-sm-10"><input type="file" name="homepageimages" class="form-control"></div>
											</div>
											<div class="form-group">
												<button type="submit" id="send_form" class="btn btn-success">Submit</button>
											</div>
			...
			<!---------------------------------------------------------------- causes add -------------------------------------->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/causes-add-confirm');?>" enctype="multipart/form-data" method="post">
					...
					<!-----------------#############################  member add  ########################################################################--------------------->
								<div id="tab-7" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/member-add-confirm');?>" enctype="multipart/form-data" method="post">
												
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Name:</label>
                                                <div class="col-sm-10"><input type="text" name="name" class="form-control"  placeholder="0123456789"></div>
                                            </div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">email:</label>
                                                <div class="col-sm-10"><input type="text" name="email" class="form-control"  placeholder="amount"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">password:</label>
                                                <div class="col-sm-10"><input type="text" name="password" class="form-control" placeholder="Name"></div>
											</div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">phone:</label>
                                                <div class="col-sm-10"><input type="text" name="phone" class="form-control" placeholder="email"></div>
											</div>
		 ...
		 <!-----------------#############################  member add end   ########################################################################--------------------->
						 ...
						 <div id="tab-8" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/volunteer-add-confirm');?>" enctype="multipart/form-data" method="post">
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">messege:</label>
                                                <div class="col-sm-10"><input type="text" name="messege" class="form-control"></div>
											</div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">Images:</label>
                                                <div class="col-sm-10"><input type="file" name="images" class="form-control"></div>
											</div>
 		...
 		<!-----------------#############################  volunteer add end   ########################################################################--------------------->
								...
								<div id="tab-9" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
											<form  action="<?php echo base_url('admin/admin-add-confirm');?>" enctype="multipart/form-data" method="post">
