...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            ...
            <div class="block-18 color-2 align-items-stretch">
              <div class="text">
              	...
              	<p>Even the all-powerful Pointing has no control about the blind texts.</p>
								...
								<p><a href="#" class="btn btn-white px-3 py-2 mt-2">Call Now- 01402-999800</a></p>
              </div>
            </div>
          </div>
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
					...
					foreach($res as $p){
	    				...
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url('causes/images/<?php echo $p->id;?>.<?php echo $p->images;?>');"></a>
		                ...
		                <span class="fund-raised d-block">Tk<?php echo $p->amount;?></span>
		    					</div>
		    				</div>
							</div>
							<?php
    	...
    	<div class="d-md-flex">
			...
			$res = $this->om->view("*", "gallery");
	       	foreach($res as $p){
														...
														?>
	    	<a href="gallery/images/homepage/<?php echo $p->id;?>-homepagehover.<?php echo $p->images;?>" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url('gallery/images/<?php //echo $p->id;?>.<?php  echo $p->images;?>');">
	    		<div class="icon d-flex justify-content-center align-items-center">
            
	    			<span class="icon-search"></span>
          
	    		</div>
          <img  src="<?php //echo 'gallery/images/'.$p->id.'-gallerypage.'.$p->images;?>" >
				</a>
				<?php
					 }
				?>
           ...
           <section class="ftco-gallery">
			...
			$res = $this->om->view("*", "gallery");
	       	foreach($res as $p){
                            ...
                            ?>
        	<a href="gallery/images/homepage/<?php echo $p->id;?>-homepagehover.<?php echo $p->images;?>" class="image-popup d-flex justify-content-center align-items-center img ftco-animate">
              <img   alt="..."  style="padding: 0 0" height="290" width="480" src="<?php echo 'gallery/images/'.$p->id.'-gallerypage.'.$p->images;?>">
      ...
      <div class="container">
        ...
        <div class="row d-flex">
				<?php 
					...
					$res = $this->om->view("*", "blog");
					  	foreach($res as $p){
																	
																?>
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('blog/images/<?php echo $p->id;?>.<?php echo $p->images;?>');">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#"><?php echo $p->date;?></a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
                </div>
                <h3 class="heading mt-3"><a href="#"><?php echo $p->title;?></a></h3>
                <p><?php echo $p->description;?></p>
              </div>
            </div>
					</div>
	...
	//		$res = $this->om->view("*", "events", "", "","3");
	     //  	foreach($res as $p){
															
                            ?>
        	<!-- <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('events/images/<?php echo $p->id;?>.<?php echo $p->images;?>');">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#"><?php echo $p->date;?></a></div>
                ...
                <h3 class="heading mb-4"><a href="#"><?php echo $p->title;?></a></h3>
                <p class="time-loc"><span class="mr-2"><i class="icon-clock-o"></i> <?php echo $p->time;?></span> <span><i class="icon-map-o"></i> <?php echo $p->location;?></span></p>
                <p><?php echo $p->description;?></p>
